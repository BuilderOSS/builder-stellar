...
-- Grant table permissions (SELECT, INSERT, UPDATE, DELETE for data writes; ALTER for upserts)
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA chain TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA governance TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA token TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA auction TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA treasury TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA manager TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA metadata TO goldsky_writer;
GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON ALL TABLES IN SCHEMA app TO goldsky_writer;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA chain GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA governance GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA token GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA auction GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA treasury GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA manager GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA metadata GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA app GRANT SELECT, INSERT, UPDATE, DELETE, ALTER ON TABLES TO goldsky_writer;
