-- =============================================================================
-- FIX MEMBER VOTING POWER EVENT ORDER
--
-- Goldsky event IDs contain a numeric event suffix. Compare that suffix
-- numerically instead of sorting the full event ID as text.
-- =============================================================================
