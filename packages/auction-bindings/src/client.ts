...
export interface Client {
  ...
  finalize_ownership({ new_owner }: { new_owner: string | Address }, options?: MethodOptions): Promise<AssembledTransaction<void>>;
  /**
