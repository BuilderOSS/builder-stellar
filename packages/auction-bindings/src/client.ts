...
export interface Client {
  ...
  finalize_ownership({ new_owner, launch_auction }: { new_owner: string | Address; launch_auction: boolean }, options?: MethodOptions): Promise<AssembledTransaction<void>>;
  /**
