...
export class Client extends ContractClient {
  ...
  public readonly fromJson = {
    execute : this.txFromJson<any>,  upgrade : this.txFromJson<void>,  governor : this.txFromJson<string>,  get_owner : this.txFromJson<string | null>,  set_governor : this.txFromJson<void>,  accept_ownership : this.txFromJson<void>,  renounce_ownership : this.txFromJson<void>,  transfer_ownership : this.txFromJson<void>
  };
