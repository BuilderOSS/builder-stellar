...
export class Client extends ContractClient {
  ...
  public readonly fromJson = {
    token : this.txFromJson<Result<string, Error>>,  upgrade : this.txFromJson<void>,  on_minted : this.txFromJson<Result<boolean, Error>>,  initialize : this.txFromJson<Result<null, Error>>,  description : this.txFromJson<Result<string, Error>>,  items_count : this.txFromJson<number>,  project_uri : this.txFromJson<Result<string, Error>>,  get_property : this.txFromJson<Property | null>,  get_settings : this.txFromJson<Result<Settings, Error>>,  get_ipfs_data : this.txFromJson<Array<IpfsGroup>>,  renderer_base : this.txFromJson<Result<string, Error>>,  add_properties : this.txFromJson<Result<null, Error>>,  contract_image : this.txFromJson<Result<string, Error>>,  get_attributes : this.txFromJson<Result<Array<number>, Error>>,  get_properties : this.txFromJson<Array<Property>>,  ipfs_data_count : this.txFromJson<number>,  properties_count : this.txFromJson<number>,  update_description : this.txFromJson<Result<null, Error>>,  update_project_uri : this.txFromJson<Result<null, Error>>,  update_renderer_base : this.txFromJson<Result<null, Error>>,  update_contract_image : this.txFromJson<Result<null, Error>>,  delete_and_recreate_properties : this.txFromJson<Result<null, Error>>
  };
