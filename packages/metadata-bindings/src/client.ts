import {Property, Settings, ItemParam, IpfsGroup, ContractEvent} from './types.js';
...
export interface Client {
   ...
   */
  initialize({ token, project_uri, description, contract_image, renderer_base, manager, current_hash, owner }: { token: string | Address; project_uri: string; description: string; contract_image: string; renderer_base: string; manager: string | Address; current_hash: Uint8Array; owner: string | Address }, options?: MethodOptions): Promise<AssembledTransaction<Result<null, Error>>>;
  /**
   * Get description
   */
...
export class Client extends ContractClient {
   ...
   */
  propertyAddedEventFilter(): string[] {
    return this.spec.eventTopicFilter("PropertyAdded");
  }
  /**
   ...
   */
  seedGeneratedEventFilter(): string[] {
    return this.spec.eventTopicFilter("SeedGenerated");
  }
  /**
   ...
   */
  metadataInitializedEventFilter(): string[] {
    return this.spec.eventTopicFilter("MetadataInitialized");
  }
  /**
