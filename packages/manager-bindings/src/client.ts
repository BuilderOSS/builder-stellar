import {DaoRegistration, DaoCreationParams, DaoAddresses, ManagerError, ImplementationVersion, ContractEvent} from './types.js';
...
export class Client extends ContractClient {
  ...
  public readonly fromJson = {
    is_dao : this.txFromJson<boolean>,  get_dao : this.txFromJson<DaoRegistration | null>,  create_dao : this.txFromJson<Result<DaoAddresses, ManagerError>>,  get_dao_count : this.txFromJson<number>,  is_nonce_used : this.txFromJson<boolean>,  pause_factory : this.txFromJson<Result<null, ManagerError>>,  enumerate_daos : this.txFromJson<Result<Array<string>, ManagerError>>,  approve_upgrade : this.txFromJson<Result<null, ManagerError>>,  unpause_factory : this.txFromJson<Result<null, ManagerError>>,  predict_addresses : this.txFromJson<Result<DaoAddresses, ManagerError>>,  get_implementation : this.txFromJson<ImplementationVersion | null>,  is_upgrade_approved : this.txFromJson<boolean>,  revoke_implementation : this.txFromJson<Result<null, ManagerError>>,  register_implementation : this.txFromJson<Result<null, ManagerError>>,  get_latest_implementation : this.txFromJson<ImplementationVersion | null>,  set_current_implementations : this.txFromJson<Result<null, ManagerError>>
  };
   ...
   */
  daoCreatedEventFilter(): string[] {
    return this.spec.eventTopicFilter("DaoCreated");
  }
  /**
   ...
   */
  daoRegisteredEventFilter(): string[] {
    return this.spec.eventTopicFilter("DaoRegistered");
  }
  /**
   ...
   */
  upgradeApprovedEventFilter(): string[] {
    return this.spec.eventTopicFilter("UpgradeApproved");
  }
  /**
   ...
   */
  implementationRevokedEventFilter(): string[] {
    return this.spec.eventTopicFilter("ImplementationRevoked");
  }
  /**
   ...
   */
  implementationRegisteredEventFilter(): string[] {
    return this.spec.eventTopicFilter("ImplementationRegistered");
  }
  /**
